...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initWheelTime(LinearLayout timePickerView) {
        ...
        if (mPickerOptions.cyclics == null || mPickerOptions.cyclics.length < 6)
            wheelTime.setCyclic(mPickerOptions.cyclic);
        else
            wheelTime.setCyclic(mPickerOptions.cyclics);
        ...
        wheelTime.setVisibleItem(mPickerOptions.itemsVisible);
    }
