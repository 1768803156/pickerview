...
public class TimePickerBuilder {
    ...
    public TimePickerBuilder setVisibleItem(int itemsVisible) {
        mPickerOptions.itemsVisible = itemsVisible;
        return this;
    }
    ...
    public TimePickerBuilder isCyclic(boolean cyclics[]) {
        mPickerOptions.cyclics = cyclics;
        return this;
    }
